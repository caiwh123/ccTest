...
<head>
	...
	.popup-box{display:none;width:100%; height:100%;position:fixed; left:0; top:0; background-color:rgb(0,0,0); z-index:998; opacity:0.4;filter: progid:DXImageTransform.Microsoft.Alpha(opacity=40);}
	.exchange{display:none; width:50px;height:50px; position:fixed; left:50%; top:50%;  z-index:999;}
	...
	<script type="text/javascript">
		...
		function switchProject(){
			var newRegionProjectId = $("#regionalProjectId option:selected").val();
			if($("#oldRegionProjectId").val() == newRegionProjectId ){
				return;
			}
			window.location.href = "${ctx}/switchProject?regionalProjectId=" + newRegionProjectId;
		}
		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<%--<li id="push" class="dropdown">--%>
						<%--<a href="javascript:" data-href="${BASE_URL}/pushUserInfo/index" title="消息通知"><span class="icon-envelope"></span></a>--%>
					<%--</li>--%>

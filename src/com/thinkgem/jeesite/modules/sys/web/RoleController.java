...
public class RoleController extends BaseController {
	...
	public String list(Role role, Model model) {
		...
		return "/WEB-INF/views/modules/sys/roleList";
	}
	...
	public String form(Role role, Model model) {
		...
		return "/WEB-INF/views/modules/sys/roleForm";
	}
...
//		}
	...
	public String assign(Role role, Model model) {
		...
		return "/WEB-INF/views/modules/sys/roleAssign";
	}
	...
	public String selectUserToRole(Role role, Model model) {
		...
		return "/WEB-INF/views/modules/sys/selectUserToRole";
	}
	...
	public String checkName(String oldName, String name) {
		log.error("oldName="+oldName+";name"+name);
